...
public class LiveBetHolder extends RecyclerView.ViewHolder {
    ...
    TextView textViewDetail, textViewName, textViewEnterBetArena, textViewTime, textViewTeamA, textViewTeamB;
    ...
    TextView textViewParticipants, textViewPost;
    ImageView imageView;
    View view;
    Context context;
    ...
    private void setLightBlueTheme() {
        ...
        textViewEnterBetArena.setBackgroundResource(R.drawable.circular_bg_fill_lightblue);
    ...
    private void setMarronTheme() {
        ...
        textViewEnterBetArena.setBackgroundResource(R.drawable.circular_bg_fill_marron);
    ...
    private void setGreenTheme() {
        ...
        textViewEnterBetArena.setBackgroundResource(R.drawable.circular_bg_fill_green);
    ...
    private void setPurpleTheme() {
        ...
        textViewEnterBetArena.setBackgroundResource(R.drawable.circular_bg_fill_purple);
    ...
    private void setBrownTheme() {
        ...
        textViewEnterBetArena.setBackgroundResource(R.drawable.circular_bg_fill_brown);
    ...
    private void setDefaultTheme() {
        ...
        textViewEnterBetArena.setBackgroundResource(R.drawable.circular_bg_fill);
